...
public class AccountServiceIntegrationTest {
    ...
    private AccountDto dto(Long id, String name, AccountType type, String currency, Long balance) {
        return new AccountDto(id, name, type, currency, balance, 1L, null, null, 0, false);
    }

    private Account createAccount(Long id, String name, AccountType type, String currency, Long balance) {
        return Account.builder()
                .name(name).accountType(type).currency(currency)
                .balance(balance).userId(1L)
    ...
    void createAccount_storesCorrectBalance() {
        ...
        CreateAccountRequest req = new CreateAccountRequest(
                "My Wallet", AccountType.CASH, "USD", 50000L, null, null);
    ...
    void createAccount_failsForDuplicateName() {
        ...
        CreateAccountRequest req = new CreateAccountRequest(
                "Wallet", AccountType.CASH, "USD", 0L, null, null);
    ...
    void getAccounts_returnsOnlyCurrentUserAccounts() {
        ...
        when(accountRepository.findByUserIdAndDeletedFalseOrderBySortOrderAsc(1L)).thenReturn(List.of(a1, a2));
        ...
        verify(accountRepository, never()).findByUserIdAndDeletedFalseOrderBySortOrderAsc(2L);
    }
    ...
    void deleteAccount_marksAsDeleted() {
        ...
        when(accountRepository.findByUserIdAndDeletedFalseOrderBySortOrderAsc(1L)).thenReturn(List.of(acc));
