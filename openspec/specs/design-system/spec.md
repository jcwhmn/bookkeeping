...
Define the visual design system for the bookkeeping frontend, including
colors, typography, spacing, and component styling. The system combines
professional fintech aesthetics (Stripe) with Revolut-style visual
elements (gradient icons) to create a trustworthy, modern interface for
personal finance management. All design tokens SHALL be exposed as CSS
custom properties and SHALL be consistent across all pages.
