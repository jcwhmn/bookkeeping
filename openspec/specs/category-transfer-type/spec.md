...
Define the TRANSFER category type, used to represent money moving between
accounts within the same user (not income or expense). TRANSFER is a
first-class category type that filters correctly in list and search
operations, enabling accurate transaction categorization and reporting.
